...
import { Clock, Users, CheckCircle2, XCircle, BarChart3, Lock } from "lucide-react";
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>
              {isExpired
                ? `Ended ${formatDistanceToNow(Number(survey.endTime) * 1000, { addSuffix: true })}`
                : `Ends ${formatDistanceToNow(Number(survey.endTime) * 1000, { addSuffix: true })}`}
            </span>
          </div>
        ...
        {isConnected ? (
          <div className="flex flex-col gap-2">
            ...
            {survey.isActive && isExpired && isAdmin && (
              <Button
